...
class Player1(ttk.Frame):
    ...
    def save_key_card(self, event=None):
        ...
        if len(card_code) > 0:
            ...
            new_card = f"https://ws-tcg.com/wordpress/wp-content/images/cardlist/{set_initial}/{set_code}/{card_code}.png"

        try:
            urllib.request.urlretrieve(new_card, "player_left.png")
...
class Player2(ttk.Frame):
    ...
    def save_key_card(self, event=None):
        ...
        try:
            urllib.request.urlretrieve(new_card, "player_right.png")
